...
static const char *const help_lines_en[] = {
    ...
    "",
    "=== Signature ===",
    "PRIVKEY (privkey show, privkey gen [m|p|mona1|p2pkh|p2sh|p2wpkh], privkey set <WIF or RAW>)",
    "",
    "=== Hardware ===",
...
static const char *const help_lines_ja_utf8[] = {
    ...
    "PRIVKEY (privkey show, privkey gen [m|p|mona1|p2pkh|p2sh|p2wpkh], privkey set <WIFまたはRAW>)",
    "TXDELAY (txdelay n|nms|ns, 0..1000ms; 単位なしnは従来10ms単位)",
    "AXDELAY (axdelay n|nms|ns, 0..1000ms; 単位なしnは従来10ms単位)",
    "AXHANG (axhang n|nms|ns, 0..1000ms; 単位なしnは従来10ms単位)",
